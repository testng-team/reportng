...
public class ReportNGUtils {
     ...
     *
     * @param context The name results.
     * @return The sum of the name durations.
     */
     ...
     *
     * @param result Which name result to look-up.
    ...
    /**
     * @param result The name result to be checked for dependent groups.
     * @return True if this name was dependent on any groups, false otherwise.
     */
    ...
    /**
     * @param result The name result to be checked for dependent methods.
     * @return True if this name was dependent on any methods, false otherwise.
     */
     ...
     *
     * @param methods A list of name methods.
